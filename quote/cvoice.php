<?php include '../inc/landing-header2.php'; ?>
<style type="text/css">
...
<!-- id="ready-3" -->
      	...
      	<form class="form-horizontal needs-validation" action="" id="multistep_form" novalidate>
            <fieldset id="account">
	            <div class="panel-body">
	                 
                      <div class="form-group text-left">
				        <label for="quote_zip">Zip Code</label>
				        <input type="text" class="form-control quote_user" name="zip_code" required id="quote_zip" placeholder="xxxxx">
            ...
            <fieldset id="personal">
             <div class="panel-body">
				...
				<div class="form-group text-left form-check p-0">
	                    ...
	                    <label for="quote_year">Year <span>*</span></label>
              		...
              		<div class="form-group text-left form-check p-0">
	                    ...
	                    <label for="quote_make">Make <span>*</span></label>
            		...
            		<div class="form-group text-left">
	                    ...
	                    <label for="quote_model">Model <span>*</span></label>
	                    <input type="text" class="form-control quote_user stage_2" name="phoneNumber" required id="quote_model">

	                </div>
            		<div class="form-group text-left form-check p-0">

	                    <label for="quote_mileage">Mileage <span>*</span></label>
						<input type="number" class="form-control quote_class stage_2" required id="quote_mileage">
						...
						<input type="hidden" id="gclid" value="<?php echo $_GET['gclid'];?>">
            ...
            <fieldset id="contact">
             <div class="panel-body">
                ...
                <input type="button" name="submit" class="btn btn-primary m-0 multistep_submit submit-form ca_form" value="Get Quote" style='margin-left:30%' disabled /><!--  id="quote_btn" -->
